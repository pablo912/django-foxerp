    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email_verify",
                    models.BooleanField(default=False, verbose_name="verificacion"),
                ),
                ...
                (
                    "api_token_email",
                    models.TextField(blank=True, null=True, verbose_name="token email"),
                ),
                (
                    "hold",
                    models.CharField(
                        blank=True, max_length=10, null=True, verbose_name="sigla"
                    ),
                ),
